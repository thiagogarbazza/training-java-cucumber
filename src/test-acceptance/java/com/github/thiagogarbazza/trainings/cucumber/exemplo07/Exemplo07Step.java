package com.github.thiagogarbazza.trainings.cucumber.exemplo07;
...
public class Exemplo07Step {
  ...
  @Dado("^que as datas abaixo são feriados abaixo:$")
  public void queAsDatasAbaixoSãoFeriadosAbaixo(DataTable dataTable)  {
    dataTable.cells().stream().forEach(d -> CalendarioService.FERIADOS.add(toLocalDate(d.get(0))));
  }
}
